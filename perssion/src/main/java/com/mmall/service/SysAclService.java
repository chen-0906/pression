...
public class SysAclService {
    ...
    public void save(AclParam param){
        ...
        sysLogService.saveAclLog(new SysAcl(), acl);
    }
    ...
    public PageResult<SysAcl> getPageByAclModelId(int aclModelId, PageQuery page){
        BeanValidator.check(page);
        int count = sysAclMapper.countByAclModuleId(aclModelId);
        if (count > 0){
            List<SysAcl> aclList = sysAclMapper.getPageByAclModuleId(aclModelId, page);
